	...
	,doSave: function( btn ) {
		...
		if ( win.edit ) {
			...
			if ( win.down('textarea').isDirty() ) {
				Ext.Msg.confirm(locale['app.window[8]'].toUpperCase(), 'LibreRambox needs to reload the service to execute the new JavaScript code. Do you want to do it now?', function( btnId ) {
